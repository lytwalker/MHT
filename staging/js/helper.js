(function(global) {
    ...
    helper.switchMenuToActive = function() {
        ...
        classes = document.querySelector("#menu-nav-button-styles").className;
        if (classes.indexOf("active") == -1) {
            classes += " active";
            document.querySelector("#menu-nav-button-styles").className = classes;
        }
    };
